package com.example.silentmoon.screens.meditation.adapter
...
import com.example.silentmoon.screens.meditation.entity.MeditationItem
...
class MeditationAdapter(private inline val onItemClick: () -> Unit) :
    ...
    override fun onBindViewHolder(holder: MeditationViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            setImageResource(imageView8, item.imageId)
